...
/**
 * Servlet implementation class AddEaddressServlet
 */
@WebServlet("/AddEaddressServlet")
public class AddEaddressServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddEaddressServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		eaddress.setTime(time);
		eaddress.setType(type);
		try {
			if (placeService.addEaddress(eaddress)){
