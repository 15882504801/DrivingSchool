...
@WebServlet("/MakePracticePlaceServlet")
public class MakePracticePlaceServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public MakePracticePlaceServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for (int i = 1; i <= pages; i++) {
			if (i == currPage) {
				...
				sBuffer.append("<a href='MakePracticePlaceServlet?page=" + i + "'>" + i + "</a>");
			}
			sBuffer.append("");
		}
