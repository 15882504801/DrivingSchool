...
<table align="center" border="5" cellpadding="5px" cellspacing="10px" bordercolor="gold" width="50%">
  <tr>
		...
		<td bgcolor="deepskyblue" height="50" align="center">时间</td>
		<td bgcolor="deepskyblue" height="50" align="center">项目</td>
		...
		<tr>
		<td bgcolor="deepskyblue" height="50" align="center"><%=eaddress.getAddress() %></td>
		<td bgcolor="deepskyblue" height="50" align="center"><%=eaddress.getTime() %></td>
		<td bgcolor="deepskyblue" height="50" align="center"><%=eaddress.getType() %></td>
		<td bgcolor="deepskyblue" height="50" align="center"><a href="${pageContext.request.contextPath }/DelExamServlet?type=<%=eaddress.getType() %>&address=<%=eaddress.getAddress() %>&time=<%=eaddress.getTime() %>">删除</a></td>
		</tr>
		<%}%>
		<tr>
		<td colspan="4" align="center"  bgcolor="deepskyblue" height="50" align="center"><a href="/DrivingSchool/AdminManager/AddExam.jsp">添加</a></td>
		</tr>
		</table>
