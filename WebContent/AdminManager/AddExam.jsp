...
<form action="${pageContext.request.contextPath}/AddEaddressServlet? action=addEaddress" method="post">
<table align="center" border="5" cellpadding="5px" cellspacing="10px" bordercolor="gold" width="50%">
  ...
  <tr>
    <td bgcolor="deepskyblue" align="center">类型</td>
    <td align="center"><input name="type" type="text" width="299"></td>
  </tr>
   <tr>
    <td bgcolor="deepskyblue" align="center">&nbsp;</td>
    <td align="center"><input type="submit" value="确认保存" width="299"></td>
  </tr>
  </table>
</form>
